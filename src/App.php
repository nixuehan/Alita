        ...
        foreach ($this->rules as $rule => $do) {
            ...
            if(is_callable($do)) {
                ...
                if (preg_match($rule, $pathInfo, $matches)) {
                    ...
                    return ['Application\Controller\\' . ucfirst($controller),$action,$matches];
                }
            }
        }
        return ['','',[]];
...
class PathRoute implements Route
{
    ...
    public function getControllerActionParams(string $pathInfo) :array
    {
        ...
        return ['Application\Controller\\' . ucfirst($controller),$action,[]];
    }
}
...
//        @mkdir($dst);
    ...
    private function service($do,...$params) :void
    {
        ...
        $do = "Application\Console\\" . ucfirst($do);
